(function() {
    ...
    V.prototype.last = function() {
        var self = this;
        return self.mutate(createLastIterator(self));
    };
    ...
    createLastIterator = function(prev) {
        var lastIterator;
        return lastIterator = function() {
            var iter, index;
            iter = prev.createIterator();
            index = 0;
            return {
    ...
    createFilterIterator = function(prev, filter, name) {
        var filterIterator;
        return filterIterator = function() {
            var iter, next, step;
            iter = prev.createIterator();
            next = void 0;
            step = function() {
